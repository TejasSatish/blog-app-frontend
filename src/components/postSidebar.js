...
export default function PostSidebar(){
    ...
    const deletePost=(id)=>{
        console.log(id)
        axios.delete(`http://localhost:3001/blogs/del/${id}`)
    }

    const getPostEvent=(e)=>{
        const id=e.currentTarget.id;
        console.log(id)
        getPost(id)
        setBlogsLength(blogs.length - 1)
    ...
    return(
        <div className="row">
            <div className="col-md-2">
                ...
                <ul className="nav flex-column md-4">
                    {blogs.map(
                        (blog)=>{
                            return(
                                <li className="nav-item d-flex gap-2 mb-3" key={blog._id}>
                                <a className="nav-link"  >
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="feather feather-file-text align-text-bottom" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                                {blog.postName}
                                </a>
                                <button type="button" className="btn btn-secondary" onClick={ getPostEvent } id={blog._id}>
            ...
            <NewBlog postData={postValue} postId={postId}></NewBlog>
        </div>
